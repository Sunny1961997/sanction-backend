<?php
// filepath: /home/sunny/Documents/sanction-api-2/app/Console/Commands/ImportUaeEntitiesJson.php
...
class ImportUaeEntitiesJson extends Command
{
    protected $signature = 'sanctions:import-uae
        {--file=resources/json/sanction-data/UAE - Entities_simple.json : Path to UAE JSON file (relative or absolute)}
        {--debug : Print first mapped records for debugging}
        {--debug-limit=5 : How many records to print}';

    protected $description = 'Import UAE entities JSON into screening_subjects';
    ...
    public function handle(): int
    {
        ...
        foreach ($payload as $i => $item) {
            ...
            // Name
            $name = $this->stringOrNull($item['Full name (in Latin letters)'] ?? null) ?? "UAE ENTITY #{$i}";
